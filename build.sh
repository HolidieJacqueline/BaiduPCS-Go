...
# Android
CC=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/armv7a-linux-androideabi16-clang ArmBuild $name-$version"-android-16-armv7" android arm 7
CC=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang ArmBuild $name-$version"-android-21-arm64" android arm64 7
CC=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/i686-linux-android16-clang ArmBuild $name-$version"-android-16-386" android 386 7
CC=$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang ArmBuild $name-$version"-android-21-amd64" android amd64 7
